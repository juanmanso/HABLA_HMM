%% Plotea la secuencia 2D completa con los estados. Si se le agrega HMM plotea las elipses.
...
for i=2:numStates,
  ...
  h(i-1,1) = plot(copy(:,1),copy(:,2),'color',cmap(i-1,:), 'marker','o','markerfacecolor',cmap(i-1,:), 'markerSize', 5, 'linestyle','none');
